...
def run_single_simulation(**kwargs):
    ...
    if create_data:
        ...
        physical_antennas_gains_normalized = signals_creator.get_antenna_gains(normalized=True)
        ...
        data_dict = {
            ...
            'physical_antennas_gains_normalized': physical_antennas_gains_normalized
        }
...
def run_simulation(**kwargs):
    ...
    - M: a list of number of sources to be tested
    """
    #NOTE: ONLY THE run_single_simulation is valid at the moment!!!
...
#     """
#     from shelis_archive.multi_experiment_runner import MultiExperimentRunner
